      ...
      <div className="mx-auto max-w-7xl px-6 py-12 flex flex-col lg:flex-row items-center justify-between gap-8 text-center lg:text-left">
        ...
        >
          ...
          <a
            ...
            className="btn-liquid-white inline-flex items-center justify-center gap-2 bg-white text-[var(--red)] font-display uppercase tracking-wide text-sm px-4 py-3 sm:text-base sm:px-7 sm:py-3.5"
          >
