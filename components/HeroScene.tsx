    ...
    >
      <defs>
        <linearGradient id="sky" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="55%" stopColor="#12335E" />
          <stop offset="100%" stopColor="#1c4a86" />
        </linearGradient>
      ...
      <g stroke="#3a5a8c" strokeWidth="2" opacity="0.6">
      ...
      <g>
        ...
        <path d="M40 336 L20 380 L58 348 Z" fill="#aab4c4" />
      ...
      <g>
        ...
        <path d="M205 306 L188 356 L223 318 Z" fill="#aab4c4" />
      ...
      <g>
        ...
        <rect x="94" y="470" width="70" height="34" fill="#0A1F3D" stroke="#3a5a8c" />
        <rect x="20" y="436" width="70" height="34" fill="#12335E" stroke="#3a5a8c" />
        <rect x="168" y="470" width="70" height="34" fill="#C81E2C" />
        <rect x="168" y="436" width="70" height="34" fill="#8f141f" />
      </g>
      {/* ship hull hint */}
      <path d="M240 560 L400 560 L380 590 L260 590 Z" fill="#0e2c52" stroke="#3a5a8c" />

      {/* ROAD + TRUCK — middle */}
      <rect x="360" y="560" width="480" height="80" fill="#1a2c46" />
      <line x1="360" y1="600" x2="840" y2="600" stroke="#E8A33D" strokeDasharray="24 16" strokeWidth="4" opacity="0.7" />
      <g>
        {/* trailer */}
        <rect x="470" y="500" width="180" height="70" rx="4" fill="#f5f2ec" stroke="#0A1F3D" strokeWidth="3" />
        <text x="480" y="540" fontFamily="var(--font-display)" fontSize="20" fill="#C81E2C" fontWeight="700">GOSTA TRANS</text>
        <text x="480" y="558" fontFamily="var(--font-body)" fontSize="10" fill="#12335E">LOGISTIQUE &amp; BTP</text>
        {/* cab */}
        <path d="M650 500 L700 500 L718 528 L718 570 L650 570 Z" fill="#C81E2C" stroke="#8f141f" strokeWidth="2" />
        <rect x="662" y="510" width="30" height="20" rx="2" fill="#bfe3ff" opacity="0.8" />
        {/* wheels */}
      ...
      <g>
        <rect x="840" y="420" width="220" height="220" fill="#0e2137" opacity="0.7" />
        {/* building under construction, scaffolding grid */}
        <g stroke="#7c8aa0" strokeWidth="1.4" opacity="0.8">
        ...
        <path d="M1044 306 L1010 340 L1044 330 Z" fill="#aab4c4" />
